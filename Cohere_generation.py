...
def generate_goal_model(
        ...
        cohere: object,  # LLM that will be used to generate the responses
...
def main():
    ...
    config, cohere = load_config("config.json")
    ...
    for stories in set_stories:
        ...
        goal_model = generate_goal_model(stories_to_use=stories, llm = cohere,prompt_dir = config["PROMPTS_DIRECTORY"], print_text = False)
